...
exports.HashtagMark = void 0;
exports.attachHashtagClickHandler = attachHashtagClickHandler;
...
exports.HashtagMark = core_1.Mark.create({
    name: "hashtag",
...
function attachHashtagClickHandler(root, onClick) {
    const handler = (e) => {
        const target = e.target;
        const pill = target.closest("span.tag-pill[data-tag]");
        if (!pill)
            return;
        e.preventDefault();
