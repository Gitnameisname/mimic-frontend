 ...
 */
exports.themePreloadSnippet = `(function(){try{var t=localStorage.getItem("${LS_KEY}");if(t==="dark"||t==="light"){document.documentElement.setAttribute("data-theme",t);}}catch(e){}})();`;
